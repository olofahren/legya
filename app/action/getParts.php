...
$query = "SELECT DISTINCT inventory.SetID, inventory.Quantity, colors.Colorname, parts.Partname, inventory.ItemTypeID, inventory.ItemID, colors.ColorID FROM minifigs, inventory, colors, parts 
